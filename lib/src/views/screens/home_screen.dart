...
import 'package:news_app_flutter/src/controller/categoryController.dart';
import 'package:news_app_flutter/src/controller/headlinesController.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: DropdownButtonFormField(
                  ...
                  onChanged: (value) {
                    ...
                    headlineController.getArticles(country: country);
                  },
                ),
              ),
              const SizedBox(
                        ...
                        itemBuilder: (context,index) {
                          ...
                          return Padding(
                            padding: EdgeInsets.only(left: 16,
                                right: index == listCategories.length - 1 ? 16 : 0),
                            child: Obx(
                                ()=> Column(
                                children: [
                                  GestureDetector(
                                    onTap: (){
                                      ...
                                      categoryController.selectedCategoryName.value = listCategories[index].title.toLowerCase();
                                      headlineController.getArticles(country: country,category: categoryController.selectedCategoryName.toString());
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          border: categoryController.selectedCategory == index ?
                                          Border.all(
                                              color: Colors.black12,
                                              width: 1
                                          ) : null,
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 14,
                                      color: Colors.black54,
                                      fontWeight: categoryController.selectedCategory == index ? FontWeight.bold : FontWeight.normal,
                                    ),
                                  )
                                ],
                              ),
              ...
              Obx( () => headlineController.isLoading.value ? const Center(
                child: CircularProgressIndicator(),
              ) : Expanded(
                child: ListView.builder(
                  itemCount: headlineController.articleList.length,
                  // physics: const BouncingScrollPhysics(),
                  physics: const AlwaysScrollableScrollPhysics(),
                  scrollDirection: Axis.vertical,
                    shrinkWrap: true,
                  itemBuilder: (context,index){
                    Article article = headlineController.articleList[index];
                      if (index == 0) {
                        return Stack(
                          children: [
                            ClipRRect(
